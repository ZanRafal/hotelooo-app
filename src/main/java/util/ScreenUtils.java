...
public final class ScreenUtils {
    ...
    public static final String HOTEL_RESERVATION_SCREEN = "/screens/reservation_screen.fxml";
    ...
    public static final String HOTEL_RESERVATION_SCREEN_ID = "reservation_screen";
}
